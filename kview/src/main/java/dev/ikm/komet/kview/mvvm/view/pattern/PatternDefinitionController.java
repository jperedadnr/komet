...
public class PatternDefinitionController {
    ...
    private void initialize() {
        ChangeListener<EntityProxy> fieldsValidationListener = (obs, oldValue, newValue) -> {
        ...
        BooleanProperty invalidProperty = patternDefinitionViewModel.getProperty(IS_INVALID);
