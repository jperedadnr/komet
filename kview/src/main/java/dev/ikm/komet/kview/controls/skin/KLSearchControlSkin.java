...
public class KLSearchControlSkin extends SkinBase<KLSearchControl> {
    ...
    public KLSearchControlSkin(KLSearchControl control) {
        ...
        filterOptionsPopup.inheritedFilterOptionsProperty().setValue(FilterOptions.loadFilterOptions(control.getViewProperties().parentView(), control.getViewProperties().calculator()));
