...
public class FilterOptions implements Serializable {
    ...
    public class MainCoordinates implements Coordinates {
        ...
        {
            List<String> navigatorOptions = new ArrayList<>(Stream.of(
            ...
            navigator = new Option(OPTION_ITEM.NAVIGATOR, "navigator.title", new ArrayList<>(List.of(navigatorOptions.getFirst())),
                    navigatorOptions, new ArrayList<>(List.of(navigatorOptions.getFirst())), null, false, false, noneSet);
        }
        ...
        private Option type;
        {
            List<String> typeOptions = new ArrayList<>(Stream.of(
                    ...
                    .map(resources::getString)
                    .toList());
            type = new Option(OPTION_ITEM.TYPE, "type.title", typeOptions,
                    typeOptions, typeOptions, null, true, false, allSet);
        }
        ...
        private Option time;
        {
            List<String> dateOptions = new ArrayList<>(Stream.of("time.item1", "time.item2", "time.item3")
                    .map(resources::getString)
                    .toList());
            time = new Option(OPTION_ITEM.TIME, "time.title", new ArrayList<>(List.of(dateOptions.getFirst())),
                    dateOptions, new ArrayList<>(List.of(dateOptions.getFirst())), new ArrayList<>(), true, false, noneSet);
        }
        ...
        private Option kindOf;
        {
            List<String> kindOfOptions = new ArrayList<>(Stream.of(
                    ...
                    .map(resources::getString)
                    .toList());
            kindOf = new Option(OPTION_ITEM.KIND_OF, "kindof.title", kindOfOptions,
                    kindOfOptions, kindOfOptions, new ArrayList<>(), true, false, allExcludingSet);
        }
        ...
        private Option membership;
        {
            List<String> membershipOptions = new ArrayList<>(Stream.of(
                    ...
                    .map(resources::getString)
                    .toList());
            membership = new Option(OPTION_ITEM.MEMBERSHIP, "membership.title", membershipOptions,
                    membershipOptions, membershipOptions, null, true, false, allSet);
        }
        ...
        private Option sortBy;
        {
            ...
            sortBy = new Option(OPTION_ITEM.SORT_BY, "sortby.title", new ArrayList<>(List.of(sortByOptions.getFirst())),
                    sortByOptions, new ArrayList<>(List.of(sortByOptions.getFirst())), null, false, false, allSet);
        }
    ...
    public class LanguageCoordinates implements Coordinates {
        ...
        private Option dialect;
        {
            List<String> dialectOptions = new ArrayList<>(Stream.of(
                    ...
                    .map(resources::getString)
                    .toList());
            dialect = new Option(OPTION_ITEM.DIALECT, "dialect.option.title", dialectOptions,
                    dialectOptions, dialectOptions, null, true, false, noneSet);
        }
        ...
        private Option pattern;
        {
            ...
            pattern = new Option(OPTION_ITEM.PATTERN, "pattern.option.title", new ArrayList<>(List.of(patternOptions.getFirst())),
                    patternOptions, new ArrayList<>(List.of(patternOptions.getFirst())), null, false, false, noneSet);
        }
        ...
        private Option descriptionType;
        {
            List<String> descriptionTypeOptions = new ArrayList<>(Stream.of(
                    ...
                    .map(resources::getString)
                    .toList());
            descriptionType = new Option(OPTION_ITEM.DESCRIPTION_TYPE, "description.option.title", descriptionTypeOptions,
                    descriptionTypeOptions, new ArrayList<>(), null, true, false, noneSet);
        }
        ...
        public boolean equals(Object o) {
            ...
            if (!Objects.equals(language, that.language)) {
                System.out.println("la: " + language + " vs " + that.language);
                return false;
            }
        ...
        public LanguageCoordinates copy() {
            ...
            languageCoordinates.options.addAll(List.of(
                    language.copy(), dialect.copy(), pattern.copy(), descriptionType.copy()
            ));
            return languageCoordinates;
        }
    }

    private final List<Coordinates> filterCoordinates;
    ...
    public FilterOptions() {
        ...
        filterCoordinates = new ArrayList<>(List.of(mainCoordinates, languageCoordinatesList.getFirst()));
    }

    public List<Coordinates> getFilterCoordinates() {
    ...
    public boolean equals(Object o) {
        ...
        if (!Objects.equals(filterCoordinates, that.filterCoordinates)) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(filterCoordinates, mainCoordinates, languageCoordinatesList);
    }

    @Override
    public String toString() {
        return "FilterOptions{" +
                filterCoordinates.stream()
                        .map(Object::toString)
                        .collect(Collectors.joining(",\n")) +
                "}";
    }
